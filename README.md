### China ETF PCF Fetcher

[![Run](https://github.com/y1han/china_etf_pcf/actions/workflows/run.yml/badge.svg)](https://github.com/y1han/china_etf_pcf/actions/workflows/run.yml)

Daily PCF Fetcher on China ETFs listed in Shanghai and Shenzhen

中国A股沪深两市ETF申购赎回清单，每个交易日更新

- 在Release板块检查和下载每日结果 (Check Daily Results in **Release** Section)
